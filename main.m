...
OUTPUTPATH = '/Users/bkutler4/Desktop/hai_lab/pipeline/pipeline_outputs3';
...
%datasets =  {'IdoDOI-230914-161838_#4'};
%==================================================================================================================================================================================================

% CHANNEL INDEX
%==================================================================================================================================================================================================
channelMap = containers.Map('KeyType','char','ValueType','int32');

channelMap('IdoControl-230914-130200_#1') = 1; channelMap('IdoControl-230914-131548_#2') = 1;
channelMap('IdoControl-230914-132855_#3') = 1; channelMap('IdoControl-230914-154022_#4') = 52;
channelMap('IdoControl-230914-155318_#5') = 1; channelMap('IdoControl-230914-160601_#6') = 20;

channelMap('IdoDOI-230914-142502_#1') = 1; channelMap('IdoDOI-230914-143740_#2') = 1;
channelMap('IdoDOI-230914-144945_#3') = 1; channelMap('IdoDOI-230914-161838_#4') = 52;
channelMap('IdoDOI-230914-163140_#5') = 1; channelMap('IdoDOI-230914-164512_#6') = 20;

channelMap('IdoControl-231101-144046_#1') = 51; channelMap('IdoControl-231101-145330_#2') = 42;
channelMap('IdoControl-231101-150512_#3') = 30;

channelMap('IdoKetanserin-231101-133725_#1') = 51; channelMap('IdoKetanserin-231101-134946_#2') = 42;
channelMap('IdoKetanserin-231101-140237_#3') = 30;
%==================================================================================================================================================================================================
...
for i = 1:length(datasets)
    ...
    snippetPath = fullfile(OUTPUTPATH, sprintf('snippet%s.png',ENDPATH));
    display_signal(rawPath, filteredPath, snippetPath, BLOCKPATH, ch)
    ...
    spectrogram_plot(BLOCKPATH, spectroPath, ch);
